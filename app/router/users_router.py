...
def change_username(
    ...
    user = auth_service.check_and_change_username(current_user, username_change_request, db)
...
def change_password(
    ...
    user = auth_service.check_and_change_password(current_user, password_change_request, db)
